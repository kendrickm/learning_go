...
func main() {
    ...
    There are three passageways leading out. A north passage leads into darkness.
    To the south, a passage appears to head upward. The eastern passage appears
    flat and well traveled.`}

	darkRoom := storyNode{text: "It is pitch black. You can not see a thing."}
	...
	trap := storyNode{text: "You head down the well worn path when suddenly a trap door opens and you fall in to a pit."}
	...
	darkRoom.addChoice("S", "Try and go back south", &grue)
